...
echo"<td>".$row['datee']."</td><td><center>".$row['question']."</center></td><td>".$row['tag']."</td><td>".$row['username']."</td>";
echo "</tr>";
}
...
else
{
    echo "No Questions Posted Till now <br/><br/> <a href='postquery.html'>Click Here </a> To Post a Query";
           ...
           <br/><br/>
           To get access to all the solutions and to enjoy our services<b> <u><a href="register.html">Register Here</a></u></b>
    </section>
           </div>
